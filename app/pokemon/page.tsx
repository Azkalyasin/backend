  ...
  return (
    <div className="container mx-auto py-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Button onClick={() => router.push("/pokemon/create")} variant="default" className="bg-blue-500 hover:bg-blue-600 text-white">
          Add New Pokemon
        </Button>
      </div>
      <Table>
          ...
          {pokemons.map((pokemon) => (
            <TableRow key={pokemon._id}>
              ...
              <TableCell className="text-right space-x-2">
                <Button onClick={() => router.push(`/pokemon/${pokemon._id}/edit`)} variant="outline" size="sm" className="bg-blue-500 hover:bg-blue-600 text-white">
                  Edit
                </Button>
                <Button onClick={() => handleDelete(pokemon._id, pokemon.name)} variant="destructive" size="sm" className="bg-red-500 hover:bg-red-600 text-white">
                  Delete
                </Button>
              </TableCell>
            </TableRow>
